...
为了尊重笑来老师的工作成果，我以注解的方式对这本书修改，同时对目录结构做了适当调整。

> 注解内容是我长期思考的结果，但由于区块链技术比较新，我只能做到尽可能正确，但不代表我的观点会一直正确，所以这本书中的内容我会一直更新下去——谁让我这么痴迷区块链哪？！
>
> 目录调整是将比特币章节中的5.区块链究竟是什么 6.区块链技术会改变世界吗？挪到了区块链章节。
